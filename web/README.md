...
Демо: `andrew` / `CadrShow26` (или кнопка на `/auth`) — в сайдбаре переключатель ролей актёр / CD / агент. Чаты и отклики демо — в браузере.
...
| Логин | Пароль | Роль |
|---|---|---|
| `andrew` | `CadrShow26` | демо-владелец · switch 3 ролей |
| `demo` | `CadrShow26` | то же (алиас) |
